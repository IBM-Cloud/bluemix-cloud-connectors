...
/**
 * Represents the Watson Conversation VCAP_SERVICE info.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonConversationServiceInfo extends BaseServiceInfo {

    /**
     * Scheme. This is not a real scheme but is needed for local config to work.
     */
    public static final String SCHEME = "conversation";
     ...
     */
    public WatsonConversationServiceInfo(
            final String id,
    ...
    public String toString() {
        return "WatsonConversationServiceInfo"
                + '{'
                + "id=" + id + ", "
                + "username=" + username + ", "
                + "password=" + password + ", "
