...
/**
 * Represents the Watson Discovery VCAP_SERVICE info.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonDiscoveryServiceInfo extends BaseServiceInfo {
     ...
     */
    public WatsonDiscoveryServiceInfo(
            final String id,
    ...
    public boolean equals(Object obj) {
        ...
        final WatsonDiscoveryServiceInfo other = (WatsonDiscoveryServiceInfo) obj;
    ...
    public String toString() {
        return "WatsonDiscoveryServiceInfo"
                + '{'
                + "id=" + id + ", "
                + "username=" + username + ", "
                + "password=" + password + ", "
