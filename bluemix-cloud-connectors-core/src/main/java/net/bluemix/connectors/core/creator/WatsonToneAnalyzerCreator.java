 ...
 * {@link com.ibm.watson.developer_cloud.tone_analyzer.v3.ToneAnalyzer} object
 * using the service credentials for the Watson Tone Analyzer service.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 */
public class WatsonToneAnalyzerCreator extends AbstractServiceConnectorCreator<ToneAnalyzer, WatsonToneAnalyzerServiceInfo> {
