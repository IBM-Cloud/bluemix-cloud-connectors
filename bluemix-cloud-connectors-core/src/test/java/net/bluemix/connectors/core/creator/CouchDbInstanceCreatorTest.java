...
public class CouchDbInstanceCreatorTest {
  
  private CouchDbInstanceCreator creator;

  @Before
  public void setUp() throws Exception {
    creator = new CouchDbInstanceCreator();
  }
  ...
  public void testCreate() {
    ...
    assertTrue(creator.create(serviceInfo, new ServiceConnectorConfig(){}) instanceof CouchDbInstance);
  }
