...
/**
 * Creates a new {@link WatsonSpeechToTextServiceInfo}.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonSpeechToTextServiceInfoCreator
        extends CloudFoundryServiceInfoCreator<WatsonSpeechToTextServiceInfo> {

    /**
     * Constructor.
     */
    public WatsonSpeechToTextServiceInfoCreator() {
        super(new Tags(), WatsonSpeechToTextServiceInfo.SCHEME);
    }
    ...
    public boolean accept(final Map<String, Object> serviceData) {
        ...
        if (obj instanceof String) {
            ...
            result = "speech_to_text".equals(label);
        }
        return result;
    }

    @Override
    public WatsonSpeechToTextServiceInfo createServiceInfo(final Map<String, Object> serviceData) {
        String id = null;
        ...
        return new WatsonSpeechToTextServiceInfo(id, username, password, url);
    }
