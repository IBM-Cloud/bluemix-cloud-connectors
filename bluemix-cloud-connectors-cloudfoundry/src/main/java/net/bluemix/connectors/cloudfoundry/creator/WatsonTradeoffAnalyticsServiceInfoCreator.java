...
/**
 * Creates a new {@link WatsonTradeoffAnalyticsServiceInfo}.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonTradeoffAnalyticsServiceInfoCreator
        extends CloudFoundryServiceInfoCreator<WatsonTradeoffAnalyticsServiceInfo> {

    /**
     * Constructor.
     */
    public WatsonTradeoffAnalyticsServiceInfoCreator() {
        super(new Tags(), WatsonTradeoffAnalyticsServiceInfo.SCHEME);
    }
    ...
    public boolean accept(final Map<String, Object> serviceData) {
        ...
        if (obj instanceof String) {
            ...
            result = "tradeoff_analytics".equals(label);
        }
        return result;
    }

    @Override
    public WatsonTradeoffAnalyticsServiceInfo createServiceInfo(final Map<String, Object> serviceData) {
        String id = null;
        ...
        return new WatsonTradeoffAnalyticsServiceInfo(id, username, password, url);
    }
