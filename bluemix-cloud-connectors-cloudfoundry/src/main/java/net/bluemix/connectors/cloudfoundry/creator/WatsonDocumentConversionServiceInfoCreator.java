...
/**
 * Creates a new {@link WatsonDocumentConversionServiceInfo}.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonDocumentConversionServiceInfoCreator
        extends CloudFoundryServiceInfoCreator<WatsonDocumentConversionServiceInfo> {

    /**
     * Constructor.
     */
    public WatsonDocumentConversionServiceInfoCreator() {
        super(new Tags(), WatsonDocumentConversionServiceInfo.SCHEME);
    }
    ...
    public boolean accept(final Map<String, Object> serviceData) {
        ...
        if (obj instanceof String) {
            ...
            result = "document_conversion".equals(label);
        }
        return result;
    }

    @Override
    public WatsonDocumentConversionServiceInfo createServiceInfo(final Map<String, Object> serviceData) {
        String id = null;
        ...
        return new WatsonDocumentConversionServiceInfo(id, username, password, url);
    }
