...
public class DatabasesForMongoDBServiceInfoCreator
        extends DatabasesForCloudServiceInfoCreator<DatabasesForMongoDBServiceInfo> {
    ...
    @Override
    public DatabasesForMongoDBServiceInfo createServiceInfo(Map<String, Object> serviceData) {
        ...
        return new DatabasesForMongoDBServiceInfo(id, Base64.getDecoder().decode(cert64), uri);
    }
}