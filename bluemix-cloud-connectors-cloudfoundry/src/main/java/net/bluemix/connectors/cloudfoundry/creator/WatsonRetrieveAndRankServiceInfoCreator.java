...
/**
 * Creates a new {@link WatsonRetrieveAndRankServiceInfo}.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonRetrieveAndRankServiceInfoCreator
        extends CloudFoundryServiceInfoCreator<WatsonRetrieveAndRankServiceInfo> {

    /**
     * Constructor.
     */
    public WatsonRetrieveAndRankServiceInfoCreator() {
        super(new Tags(), WatsonRetrieveAndRankServiceInfo.SCHEME);
    }
    ...
    public boolean accept(final Map<String, Object> serviceData) {
        ...
        if (obj instanceof String) {
            ...
            result = "retrieve_and_rank".equals(label);
        }
        return result;
    }

    @Override
    public WatsonRetrieveAndRankServiceInfo createServiceInfo(final Map<String, Object> serviceData) {
        String id = null;
        ...
        return new WatsonRetrieveAndRankServiceInfo(id, username, password, url);
    }
