...
/**
 * Creates a new {@link WatsonNaturalLanguageClassifierServiceInfo}.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonNaturalLanguageClassifierServiceInfoCreator
        extends CloudFoundryServiceInfoCreator<WatsonNaturalLanguageClassifierServiceInfo> {

    /**
     * Constructor.
     */
    public WatsonNaturalLanguageClassifierServiceInfoCreator() {
        super(new Tags(), WatsonNaturalLanguageClassifierServiceInfo.SCHEME);
    }
    ...
    public boolean accept(final Map<String, Object> serviceData) {
        ...
        if (obj instanceof String) {
            ...
            result = "natural_language_classifier".equals(label);
        }
        return result;
    }

    @Override
    public WatsonNaturalLanguageClassifierServiceInfo createServiceInfo(final Map<String, Object> serviceData) {
        String id = null;
        ...
        return new WatsonNaturalLanguageClassifierServiceInfo(id, username, password, url);
    }
