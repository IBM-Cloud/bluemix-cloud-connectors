...
/**
 * Creates a new {@link WatsonTextToSpeechTextServiceInfo}.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonTextToSpeechServiceInfoCreator
        extends CloudFoundryServiceInfoCreator<WatsonTextToSpeechServiceInfo> {

    /**
     * Constructor.
     */
    public WatsonTextToSpeechServiceInfoCreator() {
        super(new Tags(), WatsonTextToSpeechServiceInfo.SCHEME);
    }
    ...
    public boolean accept(final Map<String, Object> serviceData) {
        ...
        if (obj instanceof String) {
            ...
            result = "text_to_speech".equals(label);
        }
        return result;
    }

    @Override
    public WatsonTextToSpeechServiceInfo createServiceInfo(final Map<String, Object> serviceData) {
        String id = null;
        ...
        return new WatsonTextToSpeechServiceInfo(id, username, password, url);
    }
