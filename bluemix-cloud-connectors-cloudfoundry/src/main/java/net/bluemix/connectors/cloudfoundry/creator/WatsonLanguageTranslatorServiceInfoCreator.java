...
import net.bluemix.connectors.core.info.WatsonLanguageTranslatorServiceInfo;

import org.springframework.cloud.cloudfoundry.CloudFoundryServiceInfoCreator;
import org.springframework.cloud.cloudfoundry.Tags;

/**
 * Creates a new {@link WatsonLanguageTranslatorServiceInfo}.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonLanguageTranslatorServiceInfoCreator
        extends CloudFoundryServiceInfoCreator<WatsonLanguageTranslatorServiceInfo> {

    /**
     * Constructor.
     */
    public WatsonLanguageTranslatorServiceInfoCreator() {
        super(new Tags(), WatsonLanguageTranslatorServiceInfo.SCHEME);
    }
    ...
    public boolean accept(final Map<String, Object> serviceData) {
        ...
        if (obj instanceof String) {
            ...
            result = "language_translator".equals(label);
        }
        return result;
    }

    @Override
    public WatsonLanguageTranslatorServiceInfo createServiceInfo(final Map<String, Object> serviceData) {
        String id = null;
        ...
        return new WatsonLanguageTranslatorServiceInfo(id, username, password, url);
    }
