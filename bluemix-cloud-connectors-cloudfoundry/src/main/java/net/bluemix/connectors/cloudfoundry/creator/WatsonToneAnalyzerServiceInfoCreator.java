...
import net.bluemix.connectors.core.info.WatsonToneAnalyzerServiceInfo;

import org.springframework.cloud.cloudfoundry.CloudFoundryServiceInfoCreator;
import org.springframework.cloud.cloudfoundry.Tags;

/**
 * Creates a new {@link WatsonToneAnalyzerServiceInfo}.
 *
 * @author Hans W. Uhlig <hans.uhlig@ibm.com>
 *
 */
public class WatsonToneAnalyzerServiceInfoCreator
        extends CloudFoundryServiceInfoCreator<WatsonToneAnalyzerServiceInfo> {

    /**
     * Constructor.
     */
    public WatsonToneAnalyzerServiceInfoCreator() {
        super(new Tags(), WatsonToneAnalyzerServiceInfo.SCHEME);
    }
    ...
    public boolean accept(final Map<String, Object> serviceData) {
        ...
        if (obj instanceof String) {
            ...
            result = "tone_analyzer".equals(label);
        }
        return result;
    }

    @Override
    public WatsonToneAnalyzerServiceInfo createServiceInfo(final Map<String, Object> serviceData) {
        String id = null;
        ...
        return new WatsonToneAnalyzerServiceInfo(id, username, password, url);
    }
