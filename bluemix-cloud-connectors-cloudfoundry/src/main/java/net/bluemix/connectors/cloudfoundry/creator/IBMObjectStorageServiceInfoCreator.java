...
/**
 * Handles creating service info for the Object Storage service while running in
 * Cloud Foundry.
 *
...
public class IBMObjectStorageServiceInfoCreator extends CloudFoundryServiceInfoCreator<IBMObjectStorageServiceInfo> {
    ...
    public IBMObjectStorageServiceInfo createServiceInfo(Map<String, Object> serviceData) {
        ...
        if (credObject instanceof Map<?, ?>) {
            ...
            if (authUrlObj instanceof String) {
                authUrl = (String) authUrlObj;
            }
            if (domainNameObj instanceof String) {
                domainName = (String) domainNameObj;
            }
            if (domainIdObj instanceof String) {
                domainId = (String) domainIdObj;
            }
            if (passwordObj instanceof String) {
                password = (String) passwordObj;
            }
            if (projectObj instanceof String) {
                project = (String) projectObj;
            }
